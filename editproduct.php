        ...
        <div class="row input-container">
            ...
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" data-rule-required="true" class="input-field" value="<?php echo $row[3]; ?>" name="stock" id="stock">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" data-rule-required="true" class="input-field" value="<?php echo $row[4]; ?>" name="discount" id="discount">
                    </div>
                </div>
            </div>
            <!--            <div class="col-sm-6">-->
        ...
        <div class="row input-container">
            ...
            <div class="col-sm-6">
                <textarea name="description" data-rule-required="true" id="description" class="input-field" cols="50"
                          rows="5"><?php echo $row[6]; ?></textarea>
            </div>
            <div class="col-sm-4">
                <img style="height: 100px;width: 100px" src="<?php echo $row[5]; ?>" alt="">
            </div>
        </div>
        <div class="row input-container">
