                    ...
                    <div class="col-lg-6 text-right">
                        <div class="header-top-settings">
                            <ul class="nav align-items-center justify-content-end">
                                <li class="language">
                                    <i class="fa fa-user"></i> Welcome, <?php echo $username;?>
                                    <i class="fa fa-angle-down"></i>
                                    <ul class="dropdown-list">
                                        <li><a href="admin_changepassword.php">Change Password</a></li>
                                        <li><a href="adminlogout.php">log out <i class="fa fa-power-off"></i></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="main-menu">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        ...
                                        <li class="position-static"><a href="#">Admin <i
                                        ...
                                        <li class="position-static"><a href="vieworder.php">View Orders</a></li>
<!--                                        <li class="position-static"><a href="#">Welcome, --><?php //echo $username; ?><!--<i-->
<!--                                                        class="fa fa-angle-down"></i></a>-->
<!--                                            <ul class="megamenu dropdown">-->
<!--                                                <li class="mega-title">-->
<!--                                                    <ul>-->
