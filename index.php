    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/kkkk.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/jjj.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/iiii.jpeg">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        ...
                                        <div class="button-group">
                                            <a href="product-details.php?q=<?php echo $product_row[0] ?>"><span
...
<!-- Mirrored from demo.hasthemes.com/corano-preview/corano/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2019 05:56:51 GMT -->
</html>